...
class UserInformation(BaseSchema):
    ...
    ----------
        ...
        phone (Optional[str]): Mobile/phone number
        portfolio (Optional[str]): Portfolio/personal website URL
        linkedin (Optional[str]): LinkedIn profile URL or username
        github (Optional[str]): GitHub profile URL or username
        leetcode (Optional[str]): LeetCode profile URL or username
        geeksforgeeks (Optional[str]): GeeksforGeeks profile URL or username
...
class Resume(BaseSchema):
    ...
    selected_template: str = "ats_standard"
